...
* [`src/pp_pwa/styles.cljs`](src/pp_pwa/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/pp_pwa/`](src/pp_pwa/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/pp_pwa/core.cljs): contains the SPA entry point, `init`
* [`test/pp_pwa/`](test/pp_pwa/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `pp-pwa` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/pp_pwa/config.cljs) defaults to `true` in
...
```clj
(ns pp-pwa.example
  (:require [pp-pwa.config :as config])
